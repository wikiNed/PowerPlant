...
$("#closeLayer").click(function() {
	...
	/*
	if(earthToolsDiv) {
		BalloonHtml.removeItemStle("LayerManager");	//EarthMenu Modify
	}
	*/
});
...
window.showDialog = function(src, clickId, _onClose) {
	...
	var title = "";
	var titleImg = "";
	var menuNode = EarthMenu.getMenuNode(clickId);	//EarthMenu Modify
	title = menuNode.title;
	titleImg = menuNode.image;
	menuItem = menuNode.childItems;
	/*
	...
	$("#id_left_operator").dialog({
		...
		height: $(document).height(),	// - 70, //EarthMenu Modify
		width: 254
	}).panel("move", {
		top: "0px",	//"70px",	//EarthMenu Modify
		left: "0px"
	});
